import '../Waterkwaliteit/Waterkwaliteit.css';
        ...
        <div className="inner-section">
          <div className="horizontal-flex-row">
            <div className="image-container">
                ...
                <p className="bold-text">Wat betekent de Kaderrichtlijn Water voor jou?</p>
                <img className="image-water" src="/Aquathermie.png" alt="foto aquathermie"/>
            </div>
            ...
            <div className="text-container">
                ...
                <ul>
                  <li><i className="fa fa-arrow-right" aria-hidden="true"></i> Het verzorgen van kennissessies</li>
                  <li><i className="fa fa-arrow-right" aria-hidden="true"></i> Analyse van huidige KRW-risico’s en kansen</li>
                  <li><i className="fa fa-arrow-right" aria-hidden="true"></i> Propositieverbetering</li>
                </ul>
              </div>
